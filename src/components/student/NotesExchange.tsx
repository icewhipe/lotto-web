...
import { FileText, Download, Upload, Star } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Демо-данные • File upload в разработке
          </p>
        </div>
      ...
      <div className="space-y-3">
        {mockNotes.map((note, index) => (
          ...
          >
            ...
            <button className="p-3 rounded-xl bg-violet-50 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400 hover:bg-violet-100 dark:hover:bg-violet-900/40 transition-colors disabled:opacity-50" disabled>
      ...
      <p className="text-center text-sm text-gray-500 dark:text-gray-400 p-4">
        💡 Multer готов на backend • Скоро можно будет загружать файлы
      </p>
    </div>
  )
}
